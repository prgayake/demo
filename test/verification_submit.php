...
<body>
  ...
  <form class="logform" method="post" action="verification_submit.php" >
    <h1>Verifcation </h1>
     <div class="login-box">

      <label>Please Enter Valid Code </label>
    <div class="user-box">
    ...
    <button class="submit" type="submit" name="checkcode"> submit</button>
...
<?php
  ...
  require 'passrecover.php';
       ...
       {
          $otp= $_POST['OTP'];
          $check_code = "SELECT * FROM userdetails WHERE code = $otp";
          $code_res = mysqli_query($conn, $check_code);
          if(mysqli_num_rows($code_res) > 0)
          {
            echo '<script type="text/javascript">alert("OTP Verified")</script>';
           echo '<script type="text/javascript">
        location.replace("resetpass.php");'
          }
          else
          {
             
            echo '<script type="text/javascript">alert("OTP not Verified")</script>';
